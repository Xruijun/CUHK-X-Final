...
from utils import qwenvl_inference,videollava_inference
...
if __name__ == "__main__":
    ...
    output_csv = f'CUHK-X-VLM/src/task_caption/predictions/{modality}/pred_videollava_new.csv'
    ...
    prompt = "USER: <video>"+ prompt + " ASSISTANT:"
    ...
    for s in file_list:
        ...
        for s1 in file_list_s1:
            ...
            if not os.path.exists(video_path):
                ...
                gc.collect()
                try:
                    res = videollava_inference(video_path, prompt, model, processor)
                    print(video_path)
                    print(res)
                    # raise ValueError
